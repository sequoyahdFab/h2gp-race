...
function AppInner() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F4F6F9', fontFamily: "'Barlow', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { font-family: 'Barlow', sans-serif; background: #F4F6F9; color: #111827; -webkit-font-smoothing: antialiased; }
        .app-wrap { animation: fadeIn 0.25s ease; }

        input, select, textarea { border: 1.5px solid #D1D5DB; border-radius: 7px; padding: 9px 12px; font-size: 15px; font-family: 'Barlow', sans-serif; font-weight: 500; background: #FFFFFF; color: #111827; outline: none; transition: border-color 0.15s, box-shadow 0.15s; width: 100%; }
        ...
        .section-label { font-family: 'Barlow Condensed', sans-serif; font-size: 12px; font-weight: 700; color: #9CA3AF; text-transform: uppercase; letter-spacing: 0.1em; margin: 16px 0 8px; }

        .tab-bar { display: flex; border-bottom: 2px solid #E5E7EB; overflow-x: auto; background: #FFFFFF; padding: 0 16px; }
        .role-tab { padding: 10px 16px; font-family: 'Barlow Condensed', sans-serif; font-size: 14px; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; cursor: pointer; border: none; background: none; color: #9CA3AF; border-bottom: 2.5px solid transparent; margin-bottom: -2px; transition: color 0.15s; white-space: nowrap; }
